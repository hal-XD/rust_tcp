...
pub struct SendParam {
    pub unacked_seq : u32, //ack未受信のシーケンスの先頭
    pub next : u32,
    pub window : u16,
    pub initial_seq : u32,
}
...
impl Socket {
    pub fn new(
        ...
        Ok(Self {
            ...
            recv_param : RecvParam { next: 0, window: SOCKET_BUFFER_SIZE as u16, initial_seq: 0, tail: 0 },
            status,
            sender,
        })
    }
    ...
    pub fn send_tcp_packet(
        ...
        tcp_packet.set_data_offset(5); // fixed because of no useing option filed. 5*8byte=40bits
